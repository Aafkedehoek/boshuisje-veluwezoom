...
// Rijksoverheid schoolvakanties. Hoog tarief zodra minimaal één van
// de regio's Noord, Midden of Zuid volgens de landelijke kalender vakantie heeft.
...
function quote({ arrival, departure, guests }) {
  ...
  // Voor gemengde verblijven bewaren we een gewogen gemiddelde als administratieve
  // nachtprijs; de echte berekening blijft per nacht hierboven plaatsvinden.
  const nightlyRateCents = Math.round(accommodationBeforeDiscount / nights);
